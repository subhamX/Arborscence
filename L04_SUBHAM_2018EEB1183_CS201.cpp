/**
 * 
 * THIS FILE CONTAINS CODE FOR ARBORESCENCE. 
 * IT ASSUMES THAT THE INDEGREE OF SOURCE NODE IS ZERO.
 * 
 * CODE SUBMITTED BY - SUBHAM SAHU
 * LANGUAGE USED - C++
 * ENTRY NUMBER - 2018EEB1183
 * COURSE - CS201
 * LAB - 5
 * INSTRUCTOR - DR. PUNEET GOYAL
 * TIMESTAMP - 22:47:56 15-11-2019
 * 
 **/
